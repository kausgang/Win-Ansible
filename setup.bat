...
copy .vagrant\machines\controller\virtualbox\private_key .\connection-setting\controller-private_key.ppk
copy .vagrant\machines\target\virtualbox\private_key .\connection-setting\target-private_key.ppk
